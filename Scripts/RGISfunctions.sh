...
function RGISlookupShadeset ()
{
	...
	case "${variable}" in
		...
		(rain_pet)                                  # 32
			echo "grey"
		;;
		(reservoir_capacity)                        # 33
			echo "grey"
		;;
		(rice_crop_fraction)                        # 34
			echo "grey"
		;;
		(rice_percolation_rate)                     # 35
			echo "grey"
		;;
		(rooting_depth)                             # 36
			echo "grey"
		...
		(runoff)                                    # 37
			echo "blue"
		;;
		(small_reservoir_coefficient)               # 38
			echo "grey"
		;;
		(soil_moisture)                             # 39
			echo "grey"
		;;
		(soil_moisture_change)                      # 40
			echo "blue-to-red"
		;;
		(vapor_pressure)                            # 41
			echo "blue"
		;;
		(vegetables_crop_fraction)                  # 42
			echo "grey"
		;;
		(wilting_point)                             # 43
			echo "grey"
